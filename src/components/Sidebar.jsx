...
const Sidebar = ({ isSidebarOpen, toggleSidebar }) => {
    ...
    // GET REFERENCE TO SUBMIT FUNCTION FOR SUBMITTING FORMS
            ...
            className={`sidebar ${isSidebarOpen ? "active" : ""}`}>
                <div className="sidebar-inner">
                    ...
                    <div className="overflow-y-auto -me-2 pe-1">
                        <p className="text-titleSmall h-9 grid items-center
                        px-4">Recent</p>
                    ...
                    <div className="mt-4 h-14 px-4 grid items-center text-labelLarge
                    text-light-onSurfaceVariant dark:text-dark-onSurfaceVariant
                    border-t border-light-surfaceContainerHigh
